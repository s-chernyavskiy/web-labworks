...
export class BoardColumnService {
    ...
    async create(createBoardColumnDto: CreateBoardColumnDto): Promise<BoardColumn> {
    ...
    async update(id: number, updateColumnDto: UpdateBoardColumnDto): Promise<BoardColumn> {
